          ...
          echo '<div class="row grid clearfix">';
            ...
            echo '<div class="col2 last">';
              ...
              else
              {
                ...
                echo '<a href="Change_PWD.php?user_id='.$user_id.'"><div class="col3 last"><h1> <img src="./images/icons/profile1.png" width="35px" height="35px">';
                echo '</h1>';
                echo '<span  style="font-size:20px; margin-top:5px ">Change Password</span></a></div>';
              echo '</div>';
            echo '</div>';
          echo '</div>';
